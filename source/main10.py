...
#            print(paras[j].text)
    ...
    data = {Head2:{Head3_list[0]:{Head4_list[0]:normal_list[0],
                                       ...
                                       Head4_list[3]:'',
                                       Head4_list[4]:table.table(75,document)}       
            }}
    print(data)
    with open('web_research_app_info.json','w+') as f:
    ...
    data = {Head2:{Head3_list[1]:{Head4_list[5]:normal_list[6],
                                       ...
                                       Head4_list[8]:'',
                                       Head4_list[9]:table.table(76,document)}
            }}
    print(data)  
    with open('web_design_app_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)        
    data = {Head2:{Head3_list[2]:{Head4_list[10]:normal_list[12],
                                       ...
                                       Head4_list[13]:'',
                                       Head4_list[14]:table.table(77,document)}       
            }}
    print(data)  
    with open('web_schedule_app_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[3]:{Head4_list[15]:normal_list[18],
                                       ...
                                       Head4_list[18]:'',
                                       Head4_list[19]:table.table(78,document)}       
            }}
    print(data)  
    with open('web_edit_log.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[4]:{Head4_list[20]:normal_list[24],
                                       ...
                                       Head4_list[23]:'',
                                       Head4_list[24]:table.table(79,document)}       
            }}
    print(data)  
    with open('web_prod_open_duration_rule.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[5]:{Head4_list[25]:normal_list[30],
                                       ...
                                       Head4_list[28]:'',
                                       Head4_list[29]:table.table(80,document)}       
            }}
    print(data)  
    with open('web_task_role_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[6]:{Head4_list[30]:normal_list[36],
                                       ...
                                       Head4_list[32]:'',
                                       Head4_list[33]:'',
                                       Head4_list[34]:table.table(81,document)}       
            }}
    print(data)  
    with open('web_task_role_info_new.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
