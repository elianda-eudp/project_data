...
#            print(paras[j].text)
    ...
    data = {Head2:{Head3_list[0]:{Head4_list[0]:normal_list[0],
                                       ...
                                       Head4_list[3]:'',
                                       Head4_list[4]:table.table(82,document)}       
            }}
    print(data)
    with open('web_prod_register_info.json','w+') as f:
    ...
    data = {Head2:{Head3_list[1]:{Head4_list[5]:normal_list[6],
                                       ...
                                       Head4_list[8]:'',
                                       Head4_list[9]:table.table(83,document)}
            }}
    print(data)  
    with open('web_prod_trade_ctl.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)        
    data = {Head2:{Head3_list[2]:{Head4_list[10]:normal_list[12],
                                       ...
                                       Head4_list[13]:'',
                                       Head4_list[14]:table.table(84,document)}       
            }}
    print(data)  
    with open('web_prod_channel.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[3]:{Head4_list[15]:normal_list[18],
                                       ...
                                       Head4_list[18]:'',
                                       Head4_list[19]:table.table(85,document)}       
            }}
    print(data)  
    with open('web_prod_issue_area.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[4]:{Head4_list[20]:normal_list[24],
                                       ...
                                       Head4_list[23]:'',
                                       Head4_list[24]:table.table(86,document)}       
            }}
    print(data)  
    with open('web_prod_base_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[5]:{Head4_list[25]:normal_list[30],
                                       ...
                                       Head4_list[28]:'',
                                       Head4_list[29]:table.table(87,document)}       
            }}
    print(data)  
    with open('web_prod_point_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[6]:{Head4_list[30]:normal_list[36],
                                       ...
                                       Head4_list[33]:'',
                                       Head4_list[34]:table.table(88,document)}       
            }}
    print(data)  
    with open('web_prod_cust_prop.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
