...
def fun(document):
    ...
    data = {Head2:{Head3_list[0]:{Head4_list[0]:normal_list[0],
                                       ...
                                       Head4_list[3]:'',
                                       Head4_list[4]:table.table(149,document)}       
            }}
    print(data)
    with open('gf_pub_acct_std_info.json','w+') as f:
    ...
    data = {Head2:{Head3_list[1]:{Head4_list[5]:normal_list[6],
                                       ...
                                       Head4_list[8]:'',
                                       Head4_list[9]:table.table(150,document)}
            }}
    print(data)  
    with open('gf_send_data_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)        
    data = {Head2:{Head3_list[2]:{Head4_list[10]:normal_list[12],
                                       ...
                                       Head4_list[13]:'',
                                       Head4_list[14]:table.table(151,document)}       
            }}
    print(data)  
    with open('gf_recv_capital_data_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[3]:{Head4_list[15]:normal_list[18],
                                       ...
                                       Head4_list[18]:'',
                                       Head4_list[19]:table.table(152,document)}       
            }}
    print(data)  
    ...
    data = {Head2:{Head3_list[4]:{Head4_list[20]:normal_list[24],
                                       ...
                                       Head4_list[23]:'',
                                       Head4_list[24]:table.table(153,document)}       
            }}
    print(data)  
    ...
    data = {Head2:{Head3_list[5]:{Head4_list[25]:normal_list[30],
                                       ...
                                       Head4_list[28]:'',
                                       Head4_list[29]:table.table(154,document)}       
            }}
    print(data)  
    with open('ta_sk_notify_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[6]:{Head4_list[30]:normal_list[36],
                                       ...
                                       Head4_list[33]:'',
                                       Head4_list[34]:table.table(155,document)}       
            }}
    print(data)  
    with open('ta_hk_notify_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[7]:{Head4_list[35]:normal_list[42],
                                       ...
                                       Head4_list[38]:'',
                                       Head4_list[39]:table.table(156,document)}       
            }}
    print(data)  
    with open('gf_prod_acct_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[8]:{Head4_list[40]:normal_list[48],
                                       ...
                                       Head4_list[43]:'',
                                       Head4_list[44]:table.table(157,document)}       
            }}
    print(data)  
    with open('ta_in_out_acct_ref.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[9]:{Head4_list[45]:normal_list[54],
                                       ...
                                       Head4_list[48]:'',
                                       Head4_list[49]:table.table(158,document)}       
            }}
    print(data)  
    with open('gf_hb_notify_app.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    data = {Head2:{Head3_list[10]:{Head4_list[50]:normal_list[60],
                                       ...
                                       Head4_list[53]:'',
                                       Head4_list[54]:table.table(159,document)}       
            }}
    print(data)  
    with open('gf_hb_notify_app.json','w+') as f:
        str_data = json.dumps(data)
