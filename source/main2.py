...
#                   
    ...
    data = {Head2:{Head3_list[0]:{Head4_list[0]:normal_list[0],
                                       ...
                                       Head4_list[3]:'',
                                       Head4_list[4]:table.table(2,document)}
       
            }}
    print(data)
   
    with open('gf_prod_asset_mutual_info.json','w+') as f:
    ...
    data = {Head2:{Head3_list[1]:{Head4_list[5]:normal_list[6],
                                       ...
                                       Head4_list[8]:'',
                                       Head4_list[9]:table.table(3,document)}
       
            }}
    print(data)
   
    with open('gf_prj_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
    ...
    data = {Head2:{Head3_list[2]:{Head4_list[10]:normal_list[12],
                                       ...
                                       Head4_list[13]:'',
                                       Head4_list[14]:table.table(4,document)}
       
            }}
    print(data)
   
    with open('gf_prod_prj_rel.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
