...
#            print(paras[j].text)
    ...
    data = {Head2:{Head3_list[0]:{Head4_list[0]:normal_list[0],
                                       ...
                                       Head4_list[3]:'',
                                       Head4_list[4]:table.table(34,document)}       
            }}
    print(data)  
    with open('gf_retailer_daily_redeem_info.json','w+') as f:
    ...
    data = {Head2:{Head3_list[1]:{Head4_list[5]:normal_list[6],
                                       ...
                                       Head4_list[8]:'',
                                       Head4_list[9]:table.table(35,document)}       
            }}
    print(data)  
    with open('gf_retailer_basic_info.json','w+') as f:
        str_data = json.dumps(data)
        f.write(str_data)
